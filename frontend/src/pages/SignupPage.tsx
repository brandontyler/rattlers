...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.message || 'Failed to sign up. Authentication is not yet configured.');
    } finally {
      setIsLoading(false);
    }
  };
            ...
            <div className="mt-8 pt-6 border-t border-forest-100">
              <div className="bg-gold-50 border border-gold-200 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-gold-900 mb-1">Demo Mode</p>
                    <p className="text-xs text-gold-700">
                      Authentication is not yet configured. You can browse the map and explore locations without signing up.
                    </p>
                  </div>
                </div>
              </div>
