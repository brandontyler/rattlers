...
### ✅ Trending This Week (Complete)

| Feature | Frontend | Backend | Notes |
|---------|----------|---------|-------|
| Trending section | ✅ | ✅ | Home page section showing top 8 trending locations |
| Trending API | ✅ | ✅ | GET /locations/trending with configurable limit/days |
| Score algorithm | - | ✅ | Weighted check-ins with exponential time decay |
| Hot map markers | ✅ | - | Flame badge on trending locations in map view |
| Rank badges | ✅ | - | Gold/silver/bronze badges for top 3, burgundy for 4+ |
...
| Feature | Notes |
|---------|-------|
| **mapcn Migration** | 📝 **PLAN READY** - Migrate from Leaflet to mapcn (MapLibre GL + shadcn/ui) for better performance, theme support, and modern DX. See [MAPCN_INTEGRATION_PLAN.md](MAPCN_INTEGRATION_PLAN.md) |
