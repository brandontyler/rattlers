...
| 1.5 | Popup like (auth) | Sign in, click Like on popup | Like count increments, button shows "Liked!" | [ ] |
| 1.6 | Popup report (auth) | Sign in, click Report on popup | Button shows "Reported" | [ ] |
| 1.7 | Popup like (no auth) | Sign out, click Like on popup | Shows "Sign in to like" message | [ ] |
| 1.8 | View Details link | Click "View Details" on popup | Navigates to location detail page | [ ] |
...
| 2.4 | Like button (auth) | Sign in, click Like | Count updates, button changes to "Liked!" | [ ] |
| 2.5 | Report button (auth) | Sign in, click "Report Issue" | Button shows "Reported - Thank you!" | [ ] |
| 2.6 | Like button (no auth) | Sign out, click Like | Button disabled or shows sign-in prompt | [ ] |
| 2.7 | Invalid location ID | Go to `/location/invalid-id-here` | Shows "Location Not Found" message | [ ] |
| 2.8 | Back navigation | Click "Home" breadcrumb | Returns to map view | [ ] |
...
| # | Test | Steps | Expected | Pass |
|---|------|-------|----------|------|
| 6.1 | Like persists | Like a location, refresh page | Like count still shows increased | [ ] |
| 6.2 | Rating updates | Submit star rating, check location | averageRating recalculated | [ ] |
| 6.3 | Report count | Report location, check in DB | reportCount incremented | [ ] |
