...
|---|------|-------|----------|------|
| 1.1 | Map loads | Go to http://localhost:5173 | Map displays centered on DFW | [x] |
...
| 2.11 | Back navigation | Click "Home" breadcrumb | Returns to map view | [x] |
...
| # | Test | Steps | Expected | Pass |
|---|------|-------|----------|------|
| 5.1 | CORS blocks bad origin | Call API from different domain | Request blocked | [x] |
| 5.2 | Rate limit works | Make 200+ rapid requests | Eventually returns 429 Too Many Requests | [ ] |
| 5.3 | Auth required | POST to /feedback without token | Returns 401 | [x] |
